...
class ArchiveToolbox
{
    ...
    public function promptNote(): string
    {
        ...
        return "You can search the company's scanned document archive for this employee: {$names}. "
            ...
            .'and identify a document by its index values (the invoice number, the PO number), '
            .'never by its id number, which means nothing to the person reading it. Do NOT write '
            .'a URL, a markdown link, or the words "link" or "here": every document you used '
