...
<div class="portal-main">
    ...
    <div class="grid-secondary">
        ...
        <a class="card span-1" href="{{ route('home.assistant.index') }}" aria-label="{{ __('home_ai.widget.launcher_label') }}">
            <div class="icon-wrap icon-ai">
                <img src="{{ asset('images/brand/samir-mark.png') }}" alt="">
                <span class="badge red">
                    <svg viewBox="0 0 24 24" fill="#fff" aria-hidden="true"><path d="M12 2c.9 5.4 3.6 8.1 10 10-6.4 1.9-9.1 4.6-10 10-.9-5.4-3.6-8.1-10-10 6.4-1.9 9.1-4.6 10-10Z"/></svg>
                </span>
            </div>
            <h3>{{ __('home_ai.widget.title') }}</h3>
            <p class="meta">{{ __('home_ai.widget.tagline') }}</p>
        </a>
        @endif
