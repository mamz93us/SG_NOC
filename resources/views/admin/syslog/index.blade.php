...
<div class="row g-2 mb-3">
    ...
    <div class="col-12 col-md-4"><div class="card border-0 shadow-sm"><div class="card-body py-2"><div class="text-muted small">Unique hosts</div><div class="fs-5 fw-bold">{{ number_format($stats['unique_hosts']) }}</div></div></div></div>
</div>
