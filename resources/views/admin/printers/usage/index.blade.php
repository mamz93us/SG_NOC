        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center py-3">
                    ...
                    <div class="small text-muted">Total Pages — {{ $from->format('Y-m-d') }} → {{ $to->format('Y-m-d') }}</div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center py-3">
                    ...
                    <div class="small text-muted">Color Pages</div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center py-3">
                    ...
                    <div class="small text-muted">Mono Pages</div>
                </div>
            </div>
        </div>
    </div>
            ...
            <table class="table table-hover mb-0 align-middle small">
                <thead class="table-light">
                    <tr>
                        ...
                        <th>Last Snapshot</th>
                        <th class="text-end"><a href="{{ $sortLink('pages') }}" class="text-decoration-none">Total Pages{{ $arrow('pages') }}</a></th>
                ...
                @empty
                    <tr><td colspan="7" class="text-center text-muted py-4">No usage data for this period.</td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
        ...
        <div class="card border-0 shadow-sm mt-3">
            <div class="card-body">
                ...
                <table class="table table-sm mb-0">
                    <thead><tr><th>Branch</th><th class="text-end">Total Pages</th><th class="text-end">Color</th><th class="text-end">Mono</th></tr></thead>
                    <tbody>
