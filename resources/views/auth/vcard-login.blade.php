...
<head>
    ...
    <title>My Business Card — Sign in</title>
...
<div class="card-box">
    ...
    <p class="subtitle">Sign in with your company Microsoft account to view your digital card, add it to Apple Wallet, and share it.</p>
