...
<head>
    ...
    <title>@yield('title', 'Email Marketing')</title>
...
<nav class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container-fluid px-3 px-lg-4">
        <a class="navbar-brand d-flex align-items-center gap-2 fw-bold py-1" href="{{ route('portal.marketing.dashboard') }}">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow">
                    <li class="px-3 py-2 small">
                        ...
                        <span class="badge bg-secondary mt-1">
                            {{ \App\Models\User::roleLabel(auth()->user()->role ?? 'marketing') }}
                        </span>
                    </li>
